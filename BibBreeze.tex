...
\ProvidesFile{BibBreeze.tex}[version 1.0]
...
\usepackage[backend=biber, style=BibBreeze, citestyle=numeric, datamodel=BibBreeze]{biblatex} %Should users want the in-text citations to be author-year, set citestyle as "BibBreeze-authoryear".
